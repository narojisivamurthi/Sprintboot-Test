...
## 🗺️ Master Index & Navigation Table

### ⚙️ Backend Engineering & Frameworks (`/backend`)
...
- 📱 **[react-native.md](file:///c:/Users/naroj/Desktop/Siva%20Learning/Sprintboot-Test/frontend/react-native.md)** — *React Native, New Architecture (JSI, Fabric, TurboModules), Hermes Engine, Reanimated v3, MMKV, FlashList*
- ▲ **[next-js.md](file:///c:/Users/naroj/Desktop/Siva%20Learning/Sprintboot-Test/frontend/next-js.md)** — *Next.js (App Router), SSR/SSG/ISR/CSR, 4 Caching Layers, Server Actions, Parallel/Intercepting Routes*
- ⚛️ **[redux-toolkit.md](file:///c:/Users/naroj/Desktop/Siva%20Learning/Sprintboot-Test/frontend/redux-toolkit.md)** — *Redux Toolkit (RTK), Unidirectional Data Flow, `configureStore`, `createSlice`, Immer.js, RTK Query (`createApi`)*
- 🎨 **[tailwind.md](file:///c:/Users/naroj/Desktop/Siva%20Learning/Sprintboot-Test/frontend/tailwind.md)** — *Tailwind CSS, JIT Compiler Engine, Utility-First Philosophy, Responsive Breakpoints, Dark Mode, Custom Config*
- 🅱️ **[bootstrap.md](file:///c:/Users/naroj/Desktop/Siva%20Learning/Sprintboot-Test/frontend/bootstrap.md)** — *Bootstrap 5, 12-Column Grid System, Flexbox Utilities, Native Vanilla JS (No jQuery), SASS Customization*
- 🌐 **[html.md](file:///c:/Users/naroj/Desktop/Siva%20Learning/Sprintboot-Test/frontend/html.md)** — *HTML5 & Web Security, DOM Construction, Async/Defer, OWASP (XSS/CSP/CSRF/CORS), Core Web Vitals (INP)*
- 🎨 **[css.md](file:///c:/Users/naroj/Desktop/Siva%20Learning/Sprintboot-Test/frontend/css.md)** — *CSS3, Critical Rendering Path (CRP), BFC, Flexbox/Grid, Specificity, `:has()`, `@container`, `@layer`*

### 💻 Core Programming Languages (`/languages`)
- 🟨 **[javascript.md](file:///c:/Users/naroj/Desktop/Siva%20Learning/Sprintboot-Test/languages/javascript.md)** — *JavaScript (ES6+), V8 JIT Compiler, Event Loop, Closures, `this` rules, Polyfills (`myMap`, `debounce`)*
- 🔷 **[typescript.md](file:///c:/Users/naroj/Desktop/Siva%20Learning/Sprintboot-Test/languages/typescript.md)** — *TypeScript, Compiler Pipeline, `satisfies`, Generics, Utility Types, Zod Validation, Monorepos*
- 🐍 **[python.md](file:///c:/Users/naroj/Desktop/Siva%20Learning/Sprintboot-Test/languages/python.md)** — *Python Core, CPython VM, GIL mechanics, `__slots__` memory optimization, Context Managers, Metaclasses*
